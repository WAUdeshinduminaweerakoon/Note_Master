    ...
    <div className='relative items-center justify-center px-3'>
      <div className='w-full h-full p-10 bg-transparent border border-gray-600 rounded-md bg-stone-300'>
        ...
        <div className='flex justify-end mt-2'>
          <button className='px-1 mr-2 text-xl text-black border border-black rounded-md hover:text-gray-300 focus:outline-none bg-gradient-to-r from-sky-500 to-indigo-500' onClick={() => deleteHadler(id)}>Delete</button>
